...
public class GuiRadar extends GuiScreen
{
    ...
    public void initGui()
    {
      ...
      //      else
      //      {
                GuiSmallButtonMinimap var7 = new GuiSmallButtonMinimap(option.returnEnumOrdinal(), this.width / 2 - 155 + var2 % 2 * 160, this.height / 6 + 24 + 24 * (var2 >> 1), option, this.radar.getKeyText(option));
