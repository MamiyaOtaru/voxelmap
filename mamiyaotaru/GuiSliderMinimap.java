...
public class GuiSliderMinimap extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3)
    {
        if (this.drawButton)
        {
            if (this.dragging)
            {
                ...
                ZanMinimap.instance.setOptionFloatValue(this.idFloat, this.sliderValue);
                this.displayString = ZanMinimap.instance.getKeyText(this.idFloat);
            }
